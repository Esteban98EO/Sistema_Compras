...
{
    public partial class FrmReporteRegistroProductos : Form
    {
        public FrmReporteRegistroProductos()
        {
            InitializeComponent();
        }

        private void FrmReporteRegistroProductos_Load(object sender, EventArgs e)
        {
